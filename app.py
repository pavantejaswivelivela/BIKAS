...
app.layout = html.Div([
    ...
    html.H3('The following are the interactive knowledge graphs that provides the user with the details of the biological feature, its embodiment function, its corresponding domain and the tissue from which it originates. Users can perform actions such as hover over, zoom-in, and zoom-out over the markers.',
