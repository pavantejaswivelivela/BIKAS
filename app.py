...
app.layout = html.Div([
    ...
    html.H3('A brief description about the Multifunctional Bio-inspired design ideation system can be accessed here: https://pavantejaswivelivela.github.io/Multifunctional-BID/', style={'textAlign':'center','color': 'Black'}),
    ...
    html.H3('More about the Multifunctional Bio-inspired Design (MBID) ideation system can be accessed via https://pavantejaswivelivela.github.io/Multifunctional-BID/', style={'textAlign':'center','color': 'Black'}),
    html.H3('More about the unique multifunctional bio-inspired conceptual designs can be accessed via https://sites.google.com/view/pavantejaswivelivela', style={'textAlign':'center','color': 'Black'}),
