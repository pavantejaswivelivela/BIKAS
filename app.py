...
app.layout = html.Div([
    ...
    html.H3('The following are the interactive knowledge graphs that provides the user with the details of the biological feature, its embodiment function, its corresponding domain and the tissue from which it originates.',
            style={'textAlign':'center','color': 'Black'}),
    html.H3('Biological Features: The morphological and anatomical features observed in plant and animal kingdoms. Biological Feature characteristics: Describe a feature’s appearance, apparent form, or physical trait.',
            style={'textAlign':'center','color': 'Black'}),
